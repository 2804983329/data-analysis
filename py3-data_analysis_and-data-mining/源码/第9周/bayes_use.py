...
for i in range(0,num):
    ...
    thislabel=seplabel(thisfilename)#seplabel 传入文件名，返回label
    #print(thislabel)
    thisdataarray=datatoarray("D:/Python35/testdata/"+thisfilename) #datatoarray加载数据，前面创建的函数将文件转为对应的向量
    label=bys.btest(thisdataarray,labelsall)  #识别
